...
void mips_step(mips_cpu *cpu) {
    ...
    if (getenv("NCD15_TRACE_SETUPIF")) {
        ...
        static const struct { u32 pc; const char *tag; } sites[] = {
            ...
            {0x8ee852b8u, "LANCE init: passed early-bail"},
            {0x8ee8546cu, "LANCE init: early-bail target"},
            {0x8ee4dda4u, "setup_if: jal 0x8EE84E40"},
            {0x8ee4ddacu, "setup_if: jal 0x8EE855C8 (LANCE prog)"},
            {0x8ee4ddb4u, "setup_if: skipped LANCE prog"},
